...
class Boogle:
    ...
    def time_is_up(self):
        ...
        user_answer = tkinter.messagebox.askquestion('', "Time's up! would you like to play again?")
        if user_answer == 'yes':
            Boogle(root)
        else:
            quit()
    ...
    def quit_game(self):
        ...
        :return:
        """
        user_answer = tkinter.messagebox.askquestion('', "Are you sure you wanna quit?")
        if user_answer == 'yes':
            quit()
        else:
            pass
    ...
    def button_clicked(self, x, y):
        ...
        if not boogle_main.check_if_valid(self.coor_list):  # here we can do some sign
            self.not_valid()
